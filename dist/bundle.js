(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function t(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(a){if(a.ep)return;a.ep=!0;const n=t(a);fetch(a.href,n)}})();async function q(i,e={},t){return window.__TAURI_INTERNALS__.invoke(i,e,t)}async function ee(i={}){return typeof i=="object"&&Object.freeze(i),await q("plugin:dialog|open",{options:i})}async function te(i={}){return typeof i=="object"&&Object.freeze(i),await q("plugin:dialog|save",{options:i})}class se{invoke;listen;constructor(){this.invoke=async()=>{throw new Error("Tauri not initialized")},this.listen=async()=>()=>{}}async init(){const e=window.__TAURI__;if(!e)throw new Error("Tauri API not available");this.invoke=e.core.invoke,this.listen=e.event.listen}async loadDbc(e){return await this.invoke("load_dbc",{path:e})}async clearDbc(){await this.invoke("clear_dbc")}async getDbcInfo(){return await this.invoke("get_dbc_info")}async getDbcPath(){return await this.invoke("get_dbc_path")}async decodeFrames(e){return await this.invoke("decode_frames",{frames:e})}async loadMdf4(e){return await this.invoke("load_mdf4",{path:e})}async exportLogs(e,t){return await this.invoke("export_logs",{path:e,frames:t})}async listCanInterfaces(){return await this.invoke("list_can_interfaces")}async startCapture(e,t,s=!1){await this.invoke("start_capture",{interface:e,captureFile:t,append:s})}async stopCapture(){return await this.invoke("stop_capture")}async getInitialFiles(){return await this.invoke("get_initial_files")}async saveDbcContent(e,t){await this.invoke("save_dbc_content",{path:e,content:t})}async updateDbcContent(e){return await this.invoke("update_dbc_content",{content:e})}async openFileDialog(e){const t=await ee({multiple:!1,filters:e});return Array.isArray(t)?t[0]||null:t}async saveFileDialog(e,t){return await te({filters:e,defaultPath:t})}onCanFrame(e){let t=null;return this.listen("can-frame",s=>{e(s.payload)}).then(s=>{t=s}),()=>{t&&t()}}onDecodedSignal(e){let t=null;return this.listen("decoded-signal",s=>{e(s.payload)}).then(s=>{t=s}),()=>{t&&t()}}onDecodeError(e){let t=null;return this.listen("decode-error",s=>{e(s.payload)}).then(s=>{t=s}),()=>{t&&t()}}onCaptureError(e){let t=null;return this.listen("capture-error",s=>{e(s.payload)}).then(s=>{t=s}),()=>{t&&t()}}onLiveCaptureUpdate(e){let t=null;return this.listen("live-capture-update",s=>{e(s.payload)}).then(s=>{t=s}),()=>{t&&t()}}onCaptureFinalized(e){let t=null;return this.listen("capture-finalized",s=>{e(s.payload)}).then(s=>{t=s}),()=>{t&&t()}}}const ae="modulepreload",ie=function(i){return"/"+i},N={},ne=function(e,t,s){let a=Promise.resolve();if(t&&t.length>0){let r=function(p){return Promise.all(p.map(o=>Promise.resolve(o).then(l=>({status:"fulfilled",value:l}),l=>({status:"rejected",reason:l}))))};document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),v=c?.nonce||c?.getAttribute("nonce");a=r(t.map(p=>{if(p=ie(p),p in N)return;N[p]=!0;const o=p.endsWith(".css"),l=o?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${l}`))return;const d=document.createElement("link");if(d.rel=o?"stylesheet":ae,o||(d.as="script"),d.crossOrigin="",d.href=p,v&&d.setAttribute("nonce",v),document.head.appendChild(d),o)return new Promise((h,g)=>{d.addEventListener("load",h),d.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${p}`)))})}))}function n(r){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=r,window.dispatchEvent(c),!c.defaultPrevented)throw r}return a.then(r=>{for(const c of r||[])c.status==="rejected"&&n(c.reason);return e().catch(n)})};function G(i,e){return`0x${e?i.toString(16).toUpperCase().padStart(8,"0"):i.toString(16).toUpperCase().padStart(3,"0")}`}function re(i){return i.map(e=>e.toString(16).toUpperCase().padStart(2,"0")).join(" ")}function le(i){const e=[];return i.is_extended&&e.push("EXT"),i.is_fd&&e.push("FD"),i.brs&&e.push("BRS"),i.esi&&e.push("ESI"),e.join(", ")||"-"}function ce(i,e=6){return i.toFixed(e)}function oe(i,e=4){return i.toFixed(e)}function w(i){return i.split("/").pop()?.split("\\").pop()||i}function R(i,e,t=!1){const s=i.filter(c=>c.can_id===e&&c.is_extended===t);if(s.length===0)return null;const a=new Map;for(const c of s){const v=a.get(c.dlc)||0;a.set(c.dlc,v+1)}let n=0,r=s[0].dlc;for(const[c,v]of a)v>n&&(n=v,r=c);return r}function S(i){return JSON.parse(JSON.stringify(i))}function x(i,e){return new CustomEvent(i,{detail:e,bubbles:!0,composed:!0})}function de(i){return{all:i=i||new Map,on:function(e,t){var s=i.get(e);s?s.push(t):i.set(e,[t])},off:function(e,t){var s=i.get(e);s&&(t?s.splice(s.indexOf(t)>>>0,1):i.set(e,[]))},emit:function(e,t){var s=i.get(e);s&&s.slice().map(function(a){a(t)}),(s=i.get("*"))&&s.slice().map(function(a){a(e,t)})}}}const u=de();function F(i){u.emit("dbc:changed",i)}function ve(i){u.emit("dbc:state-change",i)}function z(i){u.emit("mdf4:changed",i)}function he(i){u.emit("frame:selected",i)}function pe(i){u.emit("capture:started",i)}function ue(i){u.emit("capture:stopped",i)}function ge(i){u.emit("live:interfaces-loaded",i)}function J(i){u.emit("tab:switch",i)}function K(i){let e={...i};const t=new Set;return{get:()=>e,set(s){e={...e,...s},t.forEach(a=>a(e))},subscribe(s){return t.add(s),()=>t.delete(s)}}}const f=K({dbcFile:null,mdf4File:null,mdf4Frames:[],mdf4Signals:[]}),k=K({isCapturing:!1,currentInterface:null,frameCount:0,messageCount:0});var P;(function(i){i.Nsis="nsis",i.Msi="msi",i.Deb="deb",i.Rpm="rpm",i.AppImage="appimage",i.App="app"})(P||(P={}));async function me(){return q("plugin:app|version")}class be extends HTMLElement{unsubscribeStore=null;isCapturing=!1;handleCaptureStarted=e=>this.onCaptureStarted();handleCaptureStopped=e=>this.onCaptureStopped();constructor(){super()}connectedCallback(){this.render(),this.bindEvents(),this.unsubscribeStore=f.subscribe(()=>this.updateStatusUI()),u.on("capture:started",this.handleCaptureStarted),u.on("capture:stopped",this.handleCaptureStopped)}disconnectedCallback(){this.unsubscribeStore?.(),u.off("capture:started",this.handleCaptureStarted),u.off("capture:stopped",this.handleCaptureStopped)}onCaptureStarted(){this.isCapturing=!0,this.updateStatusUI()}onCaptureStopped(){this.isCapturing=!1,this.updateStatusUI()}render(){this.className="cv-toolbar cv-tab-pane",this.id="mdf4Tab",this.innerHTML=`
    ...
    `}bindEvents(){this.querySelector("#refreshBtn")?.addEventListener("click",()=>{this.dispatchEvent(x("refresh-interfaces",{}))}),this.querySelector("#startBtn")?.addEventListener("click",()=>{const e=this.querySelector("#interfaceSelect");e?.value&&this.dispatchEvent(x("start-capture",{interface:e.value}))}),this.querySelector("#stopBtn")?.addEventListener("click",()=>{this.dispatchEvent(x("stop-capture",{}))}),this.querySelector("#clearBtn")?.addEventListener("click",()=>{this.dispatchEvent(x("clear",{}))}),this.querySelector("#interfaceSelect")?.addEventListener("change",()=>{this.updateButtonStates(k.get())})}updateStatusUI(e){const t=this.querySelector("#statusDot"),s=this.querySelector("#statusText"),a=f.get().mdf4File;t?.classList.toggle("active",e.isCapturing),s&&(a?s.textContent=w(a):s.textContent=e.isCapturing?"Capturing...":"Idle")}updateButtonStates(e){const t=this.querySelector("#interfaceSelect"),s=this.querySelector("#startBtn"),a=this.querySelector("#stopBtn");s&&t&&(s.disabled=!t.value||e.isCapturing),a&&(a.disabled=!e.isCapturing)}}customElements.define("cv-live-toolbar",fe);class xe extends HTMLElement{isDirty=!1;isEditing=!1;messageCount=0;unsubscribeStore=null;handleStateChange=e=>this.onStateChange(e);constructor(){super()}connectedCallback(){this.render(),this.bindEvents(),u.on("dbc:state-change",this.handleStateChange),this.unsubscribeStore=f.subscribe(()=>this.updateStatusUI())}disconnectedCallback(){u.off("dbc:state-change",this.handleStateChange),this.unsubscribeStore?.()}onStateChange(e){this.isDirty=e.isDirty,this.isEditing=e.isEditing,this.messageCount=e.messageCount,this.updateUI()}render(){this.className="cv-toolbar cv-tab-pane",this.id="dbcTab",this.innerHTML=`
    ...
    `}).join(""),this.delegatedHandler||this.setupEventDelegation()}selectFrame(e){this.selectedIndex=e,this.updateSelection();const t=this.frames[e];t&&this.dispatchEvent(new CustomEvent("frame-selected",{detail:{frame:t,index:e},bubbles:!0}))}updateSelection(){const e=this.querySelector("tbody");e&&e.querySelectorAll("tr").forEach(t=>{const s=parseInt(t.dataset.index||"-1",10);t.classList.toggle("selected",s===this.selectedIndex)})}}customElements.define("cv-frames-table",Me);class ke extends HTMLElement{signals=[];errors=[];api=null;currentFrame=null;handleFrameSelected=e=>this.onFrameSelected(e);handleDbcChanged=e=>this.onDbcChanged(e);constructor(){super()}escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}connectedCallback(){u.on("frame:selected",this.handleFrameSelected),u.on("dbc:changed",this.handleDbcChanged)}disconnectedCallback(){u.off("frame:selected",this.handleFrameSelected),u.off("dbc:changed",this.handleDbcChanged)}setApi(e){this.api=e}async onFrameSelected(e){if(this.currentFrame=e.frame,e.signals.length>0){this.setSignals(e.signals,[]);return}await this.decodeCurrentFrame()}async onDbcChanged(e){if(e.action==="cleared"){this.currentFrame&&this.setSignals([],[]);return}this.currentFrame&&await this.decodeCurrentFrame()}async decodeCurrentFrame(){const e=this.currentFrame;if(!e||!this.api){this.setSignals([],[]);return}try{const t=await this.api.decodeFrames([e]);this.currentFrame===e&&this.setSignals(t.signals,t.errors)}catch(t){console.error("Failed to decode frame:",t),this.currentFrame===e&&this.setSignals([],[])}}setSignals(e,t=[]){this.signals=e,this.errors=t,this.render()}showEmpty(){this.signals=[],this.errors=[];const e=this.querySelector("tbody"),t=this.querySelector("#signalsCount"),s=this.querySelector(".cv-decode-error");e&&(e.innerHTML='<tr><td colspan="3" class="cv-signals-empty">Select a frame to view decoded signals</td></tr>'),t&&(t.textContent="Select a frame"),s&&(s.textContent="",s.classList.add("hidden"))}clear(){this.currentFrame=null,this.showEmpty()}render(){const e=this.querySelector("tbody"),t=this.querySelector("#signalsCount"),s=this.querySelector(".cv-decode-error");e&&(this.signals.length===0&&this.errors.length===0?e.innerHTML='<tr><td colspan="3" class="cv-signals-empty">No signals decoded</td></tr>':e.innerHTML=this.signals.map(a=>`
        ...
        `).join("")),t&&(t.textContent=`${this.signals.length} signals`),s&&(this.errors.length>0?(s.textContent=this.errors.join("; "),s.classList.remove("hidden")):(s.textContent="",s.classList.add("hidden")))}}customElements.define("cv-signals-panel",ke);class $e extends HTMLElement{constructor(){super()}connectedCallback(){this.bindEvents()}bindEvents(){this.querySelectorAll(".cv-input").forEach(a=>{a.addEventListener("input",()=>this.emitFilterChange())}),this.querySelectorAll(".cv-select").forEach(a=>{a.addEventListener("change",()=>this.emitFilterChange())}),this.querySelector("#clearFiltersBtn")?.addEventListener("click",()=>this.clearFilters())}getFilters(){const e=this.getInputValue("filterTimeMin"),t=this.getInputValue("filterTimeMax"),s=this.getInputValue("filterCanId"),a=this.getInputValue("filterMessage"),n=this.getInputValue("filterSignal"),r=this.getInputValue("filterDataPattern"),c=this.getInputValue("filterChannel"),v=this.getSelectValue("filterMatchStatus");return{timeMin:e?parseFloat(e):null,timeMax:t?parseFloat(t):null,canIds:Ee(s),messages:H(a),signals:H(n),dataPattern:Se(r),channel:c||null,matchStatus:v||"all"}}clearFilters(){this.setInputValue("filterTimeMin",""),this.setInputValue("filterTimeMax",""),this.setInputValue("filterCanId",""),this.setInputValue("filterMessage",""),this.setInputValue("filterSignal",""),this.setInputValue("filterDataPattern",""),this.setInputValue("filterChannel",""),this.setSelectValue("filterMatchStatus","all"),this.emitFilterChange()}updateSummary(e,t){const s=this.querySelector("#filterSummary");if(s){const a=this.getFilters(),n=W(a);n===0?s.textContent="No filters active":s.textContent=`${n} filter${n>1?"s":""} · ${e}/${t} frames`}}getInputValue(e){return this.querySelector(`#${e}`)?.value.trim()||""}setInputValue(e,t){const s=this.querySelector(`#${e}`);s&&(s.value=t)}getSelectValue(e){return this.querySelector(`#${e}`)?.value||""}setSelectValue(e,t){const s=this.querySelector(`#${e}`);s&&(s.value=t)}emitFilterChange(){this.dispatchEvent(new CustomEvent("filter-change",{detail:this.getFilters(),bubbles:!0}))}}customElements.define("cv-filters-panel",$e);function Le(){return{frames:[],filteredFrames:[],filters:{timeMin:null,timeMax:null,canIds:null,messages:null,signals:null,dataPattern:null,channel:null,matchStatus:"all"},selectedFrameIndex:null,dbcInfo:null,currentFile:null}}class _e extends HTMLElement{api=null;state;shadow;framesTable=null;signalsPanel=null;filtersPanel=null;handleDbcChanged=e=>this.onDbcChanged(e);handleCaptureStopped=e=>this.onCaptureStopped(e);unsubscribeAppStore=null;constructor(){super(),this.state=Le(),this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){this.render(),u.on("dbc:changed",this.handleDbcChanged),u.on("capture:stopped",this.handleCaptureStopped),this.unsubscribeAppStore=f.subscribe(e=>this.onAppStoreChange(e.mdf4File))}disconnectedCallback(){u.off("dbc:changed",this.handleDbcChanged),u.off("capture:stopped",this.handleCaptureStopped),this.unsubscribeAppStore?.()}onAppStoreChange(e){e&&e!==this.state.currentFile?this.loadFile(e):!e&&this.state.currentFile&&this.clearAllData()}onCaptureStopped(e){const t=e.captureFile;t&&t===this.state.currentFile&&this.loadFile(t)}setApi(e){this.api=e,this.refreshDbcInfo()}getFrames(){return this.state.frames}async onDbcChanged(e){if(e.dbcInfo)this.state.dbcInfo=e.dbcInfo;else if(e.action!=="cleared"){await this.refreshDbcInfo();return}else this.state.dbcInfo=null;this.renderFrames()}async refreshDbcInfo(){if(this.api)try{this.state.dbcInfo=await this.api.getDbcInfo(),this.renderFrames()}catch{}}async loadFile(e){if(!this.api)return;const t=this.shadow.querySelector("#loadBtn");try{t&&(t.disabled=!0,t.textContent="Loading...");const[s,a]=await this.api.loadMdf4(e);this.state.frames=s,this.state.filteredFrames=[...s],this.state.selectedFrameIndex=null,this.state.currentFile=e,f.set({mdf4File:e,mdf4Frames:s,mdf4Signals:a}),this.renderFrames(),this.signalsPanel?.clear(),this.showMessage(`Loaded ${s.length} frames`),z({action:"loaded"})}catch(s){this.showMessage(String(s),"error")}finally{t&&(t.disabled=!1,t.textContent="Open")}}render(){this.shadow.innerHTML=`
      <style>${E}</style>
    ...
    `}bindEvents(){this.shadow.querySelectorAll(".cv-tabs .cv-tab").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.tab;t&&this.switchTab(t)})})}switchTab(e){this.shadow.querySelectorAll(".cv-tabs .cv-tab").forEach(t=>t.classList.toggle("active",t.dataset.tab===e)),this.shadow.querySelectorAll(".cv-panel-body > .cv-tab-pane").forEach(t=>t.classList.toggle("active",t.id===`${e}Section`))}async loadInterfaces(){if(this.api)try{const e=await this.api.listCanInterfaces();ge({interfaces:e})}catch(e){console.warn("Could not load interfaces:",e)}}async startCapture(e){if(this.api)try{const t=f.get().mdf4File;let s=null,a=!1;if(t){const r=await this.showCaptureChoiceDialog(t);if(r==="cancel")return;r==="append"?(s=t,a=!0):r==="overwrite"&&(s=t,a=!1)}if(!s){const c=`can-capture-${new Date().toISOString().replace(/[:.]/g,"-").slice(0,19)}.mf4`;if(s=await this.api.saveFileDialog([{name:"MDF4 Files",extensions:["mf4"]}],c),!s)return}a||(this.latestUpdate=null,this.renderFromUpdate(null)),this.state.isCapturing=!0,this.state.currentInterface=e,this.state.captureFile=s,this.updateStoreStatus(),await this.api.startCapture(e,s,a);const n=a?"Appending to":"Capturing to";this.showMessage(`${n} ${w(s)}`),pe({interface:e,captureFile:s})}catch(t){console.error("[live-viewer] startCapture FAILED:",t),this.state.isCapturing=!1,this.updateStoreStatus(),this.showMessage(String(t),"error")}}showCaptureChoiceDialog(e){return new Promise(t=>{const s=w(e),a=document.createElement("div");a.className="cv-modal-overlay",a.innerHTML=`
        <div class="cv-modal">
...
`)}function D(i){return i.replace(/\\/g,"").replace(/\n/g," ").replace(/\r/g,"").replace(/"/g,"'")}class De extends HTMLElement{signals=[];selectedName=null;constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}setSignals(e){this.signals=e,this.render()}setSelected(e){this.selectedName=e,this.render()}render(){if(!this.shadowRoot)return;const e=this.signals.map(t=>{const s=this.selectedName===t.name,a=t.byte_order==="little_endian"?"LE":"BE",n=t.is_unsigned?"U":"S",r=t.unit||"-",c=t.is_multiplexer?"M":t.multiplexer_value!==null?`m${t.multiplexer_value}`:"-";return`
      ...
      `}
    `,this.shadowRoot.querySelectorAll("tbody tr").forEach(t=>{t.addEventListener("click",()=>{const s=t.dataset.name;s&&this.dispatchEvent(x("signal-select",{name:s}))})})}}customElements.define("cv-signals-table",De);class Te extends HTMLElement{signal=T();originalSignal=T();availableNodes=[];isEditing=!1;parentEditMode=!1;errorMessage=null;static get observedAttributes(){return["data-edit-mode"]}constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.parentEditMode=this.dataset.editMode==="true",this.render()}attributeChangedCallback(e,t,s){e==="data-edit-mode"&&t!==s&&(this.parentEditMode=s==="true",this.render())}setSignal(e,t){this.signal=e?S(e):T(),this.originalSignal=S(this.signal),this.isEditing=t,this.render()}setAvailableNodes(e){this.availableNodes=e,this.render()}getSignal(){return this.signal}isInEditMode(){return this.isEditing}updateSignalValues(e){if(this.signal={...this.signal,...e},this.shadowRoot&&this.isEditing){if(e.start_bit!==void 0){const t=this.shadowRoot.getElementById("start_bit");t&&(t.value=String(e.start_bit))}if(e.length!==void 0){const t=this.shadowRoot.getElementById("length");t&&(t.value=String(e.length))}}}setError(e){if(this.errorMessage=e,this.shadowRoot&&this.isEditing){const t=this.shadowRoot.querySelector(".cv-error-msg"),s=this.shadowRoot.getElementById("done-btn");t&&(t.textContent=e||"",t.style.display=e?"block":"none"),s&&(s.disabled=!!e,s.style.opacity=e?"0.5":"1",s.style.cursor=e?"not-allowed":"pointer")}}restoreOriginal(){this.signal=S(this.originalSignal),this.errorMessage=null,this.render(),this.dispatchEvent(x("signal-change",this.signal))}render(){this.shadowRoot&&(this.isEditing?this.renderEditMode():this.renderViewMode())}renderViewMode(){if(!this.shadowRoot)return;const e=this.signal.byte_order==="little_endian"?"Little Endian":"Big Endian",t=this.signal.is_unsigned?"Unsigned":"Signed",s=this.signal.unit||"-",a=this.signal.is_multiplexer?"Multiplexer (M)":this.signal.multiplexer_value!==null?`Multiplexed (m${this.signal.multiplexer_value})`:"-",r=this.signal.receivers.type==="nodes"?this.signal.receivers.nodes.join(", "):"None";this.shadowRoot.innerHTML=`
      <style>${E}
        :host { display: block; }
        .header {
          display: flex;
    ...
    `}updateBitBar(){if(!this.shadowRoot||!this.editingSignal)return;const e=this.message.dlc*8;if(e===0)return;const t=this.editingSignal.start_bit,s=this.editingSignal.length,a=this.shadowRoot.querySelector(".cv-bit-layout-header span:last-child");a&&(a.textContent=`${this.editingSignal.name||""}: ${t} - ${t+s-1}`);const n=this.shadowRoot.querySelector(".cv-bit-bar");if(n){const r=this.getActiveSignals(),c=this.editingSignal.byte_order,v=(l,d,h)=>_(l,d,h),p=(l,d,h,g)=>{const m=v(l,d,h);for(const b of r){if(b.name===g)continue;const y=b.name===this.editingSignal.name,C=y?t:b.start_bit,$=y?s:b.length,M=y?c:b.byte_order,I=v(C,$,M);if(m.start<=I.end&&I.start<=m.end)return!0}return!1},o=r.map((l,d)=>{const h=l.name===this.editingSignal.name,g=h?t:l.start_bit,m=h?s:l.length,b=h?c:l.byte_order,y=v(g,m,b),C=y.start/e*100,$=m/e*100,M=p(g,m,b,l.name),I=M?"#ef4444":h?"#3b82f6":O(d),Z=h?1:.5,Q=b==="big_endian"?"BE":"LE";return`<div class="${["cv-bit-segment",h?"current":"",M?"overlap":""].filter(Boolean).join(" ")}"
                     style="left: ${C}%; width: ${$}%; background: ${I}; opacity: ${Z};"
                     title="${l.name} (${Q}): bits ${y.start}-${y.end}${M?" (OVERLAP!)":""}">
                  ${$>8?l.name:""}
                         ...
                         </div>`;n.innerHTML=o+C}else n.innerHTML=o}}setupSliderListeners(){if(!this.shadowRoot)return;const e=this.shadowRoot.getElementById("start-bit-slider"),t=this.shadowRoot.getElementById("length-slider"),s=this.message.dlc*8,a=()=>{if(!this.editingSignal||!e||!t)return;const n=L(s,this.editingSignal.start_bit,this.editingSignal.length,this.editingSignal.byte_order);e.min=String(n.startMin),e.max=String(n.startMax),t.min=String(n.lenMin),t.max=String(n.lenMax)};e?.addEventListener("input",()=>{const n=parseInt(e.value,10);if(this.editingSignal){this.editingSignal.start_bit=n,this.shadowRoot.getElementById("start-bit-value").textContent=String(n),a();const r=L(s,n,this.editingSignal.length,this.editingSignal.byte_order);this.editingSignal.length>r.lenMax&&(this.editingSignal.length=r.lenMax,t.value=String(r.lenMax),this.shadowRoot.getElementById("length-value").textContent=String(r.lenMax));const c=this.shadowRoot.querySelector("cv-signal-editor");c?.updateSignalValues({start_bit:this.editingSignal.start_bit,length:this.editingSignal.length}),this.updateBitBar(),this.validateSignalAndSetError(c)}}),t?.addEventListener("input",()=>{const n=parseInt(t.value,10);if(this.editingSignal){this.editingSignal.length=n,this.shadowRoot.getElementById("length-value").textContent=String(n),a();const r=L(s,this.editingSignal.start_bit,n,this.editingSignal.byte_order);this.editingSignal.start_bit<r.startMin?(this.editingSignal.start_bit=r.startMin,e.value=String(r.startMin),this.shadowRoot.getElementById("start-bit-value").textContent=String(r.startMin)):this.editingSignal.start_bit>r.startMax&&(this.editingSignal.start_bit=r.startMax,e.value=String(r.startMax),this.shadowRoot.getElementById("start-bit-value").textContent=String(r.startMax));const c=this.shadowRoot.querySelector("cv-signal-editor");c?.updateSignalValues({start_bit:this.editingSignal.start_bit,length:this.editingSignal.length}),this.updateBitBar(),this.validateSignalAndSetError(c)}})}render(){if(!this.shadowRoot)return;const e=`0x${this.message.id.toString(16).toUpperCase()}`;this.shadowRoot.innerHTML=`
      <style>${E}
        :host {
          display: grid;
    ...
    `,this.setupEventListeners(),this.updateChildComponents()}setupEventListeners(){if(!this.shadowRoot)return;this.shadowRoot.getElementById("edit-msg-btn")?.addEventListener("click",()=>{this.isEditingMessage=!0,this.render()}),this.shadowRoot.getElementById("delete-msg-btn")?.addEventListener("click",()=>{this.dispatchEvent(new CustomEvent("message-delete-request",{bubbles:!0,composed:!0}))}),this.shadowRoot.getElementById("done-msg-btn")?.addEventListener("click",()=>{if(!this.message.name){alert("Message name is required");return}this.isEditingMessage=!1,this.originalMessage=S(this.message),this.notifyChange(),this.dispatchEvent(new CustomEvent("message-edit-done",{detail:this.message,bubbles:!0,composed:!0})),this.render()}),this.shadowRoot.getElementById("cancel-msg-btn")?.addEventListener("click",()=>{this.isNewMessage?this.dispatchEvent(new CustomEvent("message-edit-cancel",{bubbles:!0,composed:!0})):(this.message=S(this.originalMessage),this.isEditingMessage=!1,this.render())});const e=this.shadowRoot.getElementById("msg_name"),t=this.shadowRoot.getElementById("msg_id"),s=this.shadowRoot.getElementById("msg_dlc"),a=this.shadowRoot.getElementById("msg_sender"),n=this.shadowRoot.getElementById("msg_extended");e?.addEventListener("input",()=>{this.message.name=e.value}),t?.addEventListener("input",()=>{this.message.id=parseInt(t.value,10)||0;const o=`0x${this.message.id.toString(16).toUpperCase()}`,l=this.shadowRoot.querySelector(".cv-id-display");if(l&&(l.textContent=`(${o})`),this.isNewMessage&&this.frames.length>0){const d=R(this.frames,this.message.id,this.message.is_extended);d!==null&&d!==this.message.dlc&&(this.message.dlc=d,s&&(s.value=String(d)))}}),s?.addEventListener("change",()=>{this.message.dlc=parseInt(s.value,10)}),a?.addEventListener("change",()=>{this.message.sender=a.value}),n?.addEventListener("change",()=>{if(this.message.is_extended=n.checked,this.isNewMessage&&this.frames.length>0){const o=R(this.frames,this.message.id,this.message.is_extended);o!==null&&o!==this.message.dlc&&(this.message.dlc=o,s&&(s.value=String(o)))}});const r=this.shadowRoot.getElementById("msg_comment");r?.addEventListener("input",()=>{this.message.comment=r.value||null}),this.setupSliderListeners(),this.shadowRoot.getElementById("add-signal-btn")?.addEventListener("click",()=>{this.isAddingSignal=!0,this.selectedSignal=null,this.editingSignal=T(),this.render()}),this.shadowRoot.querySelector("cv-signals-table")?.addEventListener("signal-select",(o=>{const l=o.detail.name;this.selectedSignal===l?(this.selectedSignal=null,this.editingSignal=null,this.isEditingSignal=!1):(this.selectedSignal=l,this.editingSignal=this.message.signals.find(d=>d.name===l)||null,this.isEditingSignal=!1),this.isAddingSignal=!1,this.render()}));const p=this.shadowRoot.querySelector("cv-signal-editor");p?.addEventListener("edit-start",(()=>{this.isEditingSignal=!0;const o=this.shadowRoot.querySelector(".cv-bit-layout");if(o&&!o.querySelector(".cv-bit-sliders")){const l=this.message.dlc*8,d=this.editingSignal?.start_bit??0,h=this.editingSignal?.length??1,g=this.editingSignal?.byte_order??"little_endian",m=L(l,d,h,g),b=`
          <div class="cv-bit-sliders">
            <div class="cv-bit-slider-group">
              <div class="cv-bit-slider-label">
                <span>Start Bit</span>
