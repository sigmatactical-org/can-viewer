...
pub const STANDARD_PIDS: &[PidDef] = &[
    ...
    PidDef {
        ...
        data_bytes: 1,
        resolution: 0.5,
        decode: |d| f64::from(d[0]) / 2.0 - 64.0,
    },
    PidDef {
        pid: 0x0F,
        name: "IntakeAirTemp",
    ...
    PidDef {
        ...
        data_bytes: 2,
        resolution: 0.001,
        decode: |d| ab(d) / 1000.0,
    },
    PidDef {
        pid: 0x45,
        name: "RelativeThrottle",
        unit: "%",
        data_bytes: 1,
        resolution: 100.0 / 255.0,
        decode: percent,
